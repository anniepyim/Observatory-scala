...
function $c_Lobservatory_Interaction2$() {
  $c_O.call(this);
  this.tempToCol$1 = null;
  this.devToCol$1 = null
}
...
$c_Lobservatory_Interaction2$.prototype.init___ = (function() {
  ...
  this.tempToCol$1 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf));
  $m_sci_List$();
  ...
  this.devToCol$1 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs$1, cbf$1));
  return this
});
$c_Lobservatory_Interaction2$.prototype.yearSelection__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, sliderValue) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$2, sliderValue$1) {
    return (function() {
      return ($as_Lobservatory_Layer(selectedLayer$2.apply__O()).bounds$1.contains__I__Z($uI(sliderValue$1.apply__O())) ? $uI(sliderValue$1.apply__O()) : $as_Lobservatory_Layer(selectedLayer$2.apply__O()).bounds$1.head__I())
    })
...
$c_Lobservatory_Interaction2$.prototype.layerUrlPattern__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$3, selectedYear$1) {
    return (function() {
      return (((("target/" + $as_Lobservatory_Layer(selectedLayer$3.apply__O()).layerName$1.id$1) + "/") + selectedYear$1.apply__O()) + "/{z}/{x}-{y}.png")
    })
...
$c_Lobservatory_Interaction2$.prototype.caption__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$4, selectedYear$2) {
    return (function() {
      return ((($as_Lobservatory_Layer(selectedLayer$4.apply__O()).layerName$1.id$1 + " (") + selectedYear$2.apply__O()) + ")")
    })
  })(selectedLayer, selectedYear));
  return new $c_Lobservatory_Signal().init___F0(expr)
});
...
$c_Lobservatory_JSMain$.prototype.setupMap__Lobservatory_Signal__Lobservatory_Signal__V = (function(selectedLayer, selectedYear) {
  ...
  var map = $g.L.map(mapElement, new $c_Lleaflet_MapOptions().init___Z__I(false, 4));
  map.setView($g.L.latLng(25.0, 20.0), 2);
...
$c_Lobservatory_JSMain$$anonfun$4.prototype.apply__Lscalatags_JsDom$TypedTag = (function() {
  var jsx$9 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().input__Lscalatags_generic_TypedTag());
  ...
  var jsx$7 = $m_Lscalatags_JsDom$attrs$().min__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair($as_sci_Range(this.yearBounds$1$2.apply__O()).min__s_math_Ordering__I($m_s_math_Ordering$Int$()), $m_Lobservatory_Implicits$().intAttr$1);
  var jsx$6 = $m_Lscalatags_JsDom$attrs$().max__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair($as_sci_Range(this.yearBounds$1$2.apply__O()).max__s_math_Ordering__I($m_s_math_Ordering$Int$()), $m_Lobservatory_Implicits$().intAttr$1);
  var jsx$5 = $m_Lscalatags_JsDom$attrs$().value__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair($as_sci_Range(this.yearBounds$1$2.apply__O()).max__s_math_Ordering__I($m_s_math_Ordering$Int$()), $m_Lobservatory_Implicits$().intAttr$1);
  ...
  var this$2 = $m_Lobservatory_Implicits$();
  return jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$8, jsx$7, jsx$6, jsx$5, jsx$2, jsx$1.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(new $c_Lscalatags_DataConverters$CssNumber().init___Lscalatags_DataConverters__O__s_math_Numeric(this$2, 40, $m_s_math_Numeric$IntIsIntegral$()).em__T(), $m_Lobservatory_Implicits$().stringPixelStyle$1)]))
});
